...
title: J Gateway v0.1 persistence model
type: system
status: active
tags:
- j
...
supersedes: []
summary: 'J Gateway v0.1 uses event-sourced storage at ~/.j/gateway/: per-session transcripts/<session_id>.jsonl (truth) + sessions.json index.'
---
## J Gateway v0.1 persistence model
- Data root (default): `~/.j/gateway/`
