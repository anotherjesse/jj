...
supersedes: []
summary: 'Code reviews for J: ship-first 2-person pre-product; flag only urgent issues, suggest simplifications, direct; focus correctness/security/perf/maintainability.'
---
## Statement
When requesting code reviews, J wants feedback optimized for a **pre-product, 2-person team**:
